...
Drone::Drone() : body(Mesh::createBox(0.28f, 0.065f, 0.28f)), camBox(Mesh::createBox(0.07f, 0.050f, 0.07f))
                , arm(Mesh::createBox(0.42f, 0.020f, 0.034f)), rotor(Mesh::createCylinder(0.11f, 0.012f, 16)), cone(makeCone(1.0f, 1.0f, 20))
{}

void Drone::draw(Shader &shader, glm::vec3 camPos, glm::vec3 camFront, float rotorAngle) {
    ...
    for (int i = 0; i < 2; ++i) {
        glm::mat4 armM = glm::rotate(base, glm::radians(ARM_ANGLES[i]), glm::vec3(0.0f, 1.0f, 0.0f));
    ...
    for (int i = 0; i < 4; ++i) {
        ...
        rotorM = glm::rotate(rotorM, glm::radians(spin), glm::vec3(0.0f, 1.0f, 0.0f));
