...
Terrain::Terrain(const std::vector<glm::vec2> &boundary, const std::vector<float>     &elevations) : fairway(buildFairway(boundary, elevations)), surround(buildSurround(boundary, 0.15f)){
